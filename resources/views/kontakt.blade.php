...
@section('description', 'Nehmen Sie Kontakt zum Betreuungsdienst Ketteniß aus Aachen auf – persönlich, schnell und
    unverbindlich. Wir beraten Sie rund um haushaltsnahe Seniorenhilfe mit Herz und Verlässlichkeit.')
@section('keywords', 'Kontakt Betreuungsdienst Ketteniß, Seniorenhilfe Aachen, Beratung Betreuung, haushaltsnahe Hilfe
    Aachen, familiärer Betreuungsdienst, Kontaktformular Seniorenhilfe')
        ...
        <div class="grid lg:grid-cols-2 gap-12 items-start">
            ...
            <div class="space-y-6 text-gray-700">
                <p class="text-lg leading-relaxed">
                    Sie haben Fragen zu unseren Leistungen oder möchten direkt ein Beratungsgespräch vereinbaren? Wir sind
                    für Sie da – persönlich, zuverlässig und unverbindlich.
                </p>
                ...
                <ul class="space-y-4">
                    <li class="flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <a href="tel:+492412345678"
                                class="hover:underline text-blue-600">{{ config('company.phone') }}</a>
                        </div>
                    </li>
                    <li class="flex items-start gap-3">
                ...
                <div class="pt-4">
                    <x-button href="https://www.google.com/maps/dir//{{ config('company.adress') }}" target="_blank"
                        variant="white">
                        Route planen
                    </x-button>
                </div>
            ...
            <div class="bg-white shadow-xl rounded-xl p-6 md:p-10 space-y-6">
                ...
                <form action="{{ route('kontakt.absenden') }}" method="POST" class="space-y-6">
                    ...
                    {{-- Telefon --}}
                    <div class="relative">
                        <label for="telefon" class="block text-sm font-semibold text-gray-800 mb-1">Telefonnummer
                            (optional)</label>
                    ...
                    <div class="relative">
                        ...
                        <textarea name="nachricht" id="nachricht" rows="5" required
                            class="peer w-full rounded-lg border border-gray-300 px-4 py-3 text-gray-900 shadow-sm focus:border-brand focus:ring-1 focus:ring-brand placeholder-transparent transition"
                            placeholder="Was möchten Sie uns mitteilen?"></textarea>
                    </div>
